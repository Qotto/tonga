...
test_store_manager_local_memory_store = LocalStoreMemory(name='test_store_builder_local_memory_store')
test_store_manager_global_memory_store = GlobalStoreMemory(name='test_store_builder_global_memory_store')

test_local_memory_store.set_metadata_class(KafkaStoreMetaData)
test_global_memory_store.set_metadata_class(KafkaStoreMetaData)

test_store_manager = KafkaStoreManager(name='test_store_builder', client=tonga_kafka_client, topic_store='test-store',
                                       serializer=store_builder_serializer, loop=t_loop, rebuild=True,
                                       event_sourcing=False,
                                       local_store=test_store_manager_local_memory_store,
                                       global_store=test_store_manager_global_memory_store)
